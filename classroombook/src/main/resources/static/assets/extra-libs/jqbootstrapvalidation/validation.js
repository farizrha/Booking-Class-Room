            ...
            init: function (options) {
                ...
                $(uniqueForms).bind("submit.validationSubmit", function (e) {
                    ...
                    $allControlGroups.each(function (i, el) {
                        var $controlGroup = $(el);
                        if ($controlGroup.hasClass("issue") || $controlGroup.hasClass("templates.error")) {
                            $controlGroup.removeClass("issue").addClass("templates.error");
                            warningsFound++;
                        }
                    });
                    if (warningsFound) {
                        ...
                        $form.addClass("templates.error");
                        if ($.isFunction(settings.options.submitError)) {
                            settings.options.submitError($form, e, $inputsWithValidators.jqBootstrapValidation("collectErrors", true));
                        }
                    }
                    else {
                        $form.removeClass("templates.error");
                ...
                return this.each(function () {
                    ...
                    $this.bind((settings.options.bindEvents.length > 0 ? settings.options.bindEvents : ["keyup", "focus", "blur", "click", "keydown", "keypress", "change"]).concat(["revalidate"]).join(".validation ") + ".validation", function (e, params) {
                        ...
                        if (errorsFound.length) {
                            $controlGroup.removeClass("validate error issue").addClass(formIsSubmitting ? "templates.error" : "issue");
