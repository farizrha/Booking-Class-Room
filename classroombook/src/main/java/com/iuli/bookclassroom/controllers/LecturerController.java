...
public class LecturerController {
    ...
    public ModelAndView create(@Valid @ModelAttribute(name = "data") Lecturer lecturer,
        ...
        if (result.hasErrors()){
            GlobalMethods.setRedirectAttribute(redirectAttributes, "0", "Lecturer Addition is failed", lecturer, result);
            mView.setViewName("rediriect:/lecturer/add");
            return mView;
        }

        lecturerRepository.save(lecturer);
        GlobalMethods.setRedirectAttribute(redirectAttributes, "1", "Lecturer Addition is successful", null, null);
